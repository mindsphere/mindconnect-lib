...
// MCL Extension - Begin
#define TEST_ASSERT_NOT_NULL_RETURN(pointer) TEST_ASSERT_NOT_NULL_MESSAGE((pointer), #pointer " expected Non-NULL"); if(pointer == (void*) 0) {return;}
#define TEST_ASSERT_NOT_NULL_RETURN_MESSAGE(pointer, message) TEST_ASSERT_NOT_NULL_MESSAGE((pointer), (message)); if(pointer == (void*) 0) {return;}
// MCL Extension - End
